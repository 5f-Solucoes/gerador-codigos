...
class MigrarDadosLegados extends Command
{
    ...
    protected $description = 'Importa dados do banco legado corrigindo os IDs dos usuários';
    ...
    public function handle()
    {
        ...
        foreach ($oldUsers as $old) {
            ...
            $this->line("Mapeado: Antigo [$oldId] -> Novo [$newId] ({$old->NOME})");
        }
        ...
        $this->newLine();
        $this->info('Migração concluída! Usuários foram remapeados.');
    }
}